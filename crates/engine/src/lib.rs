...
use spin_appconfig::host_component::ComponentConfig;
use spin_appconfig::Resolver;
...
pub struct RuntimeContext<T> {
    ...
    /// Component configuration.
    pub component_config: Option<spin_appconfig::host_component::ComponentConfig>,
...
impl<T: Default> Builder<T> {
    ...
    pub fn link_appconfig(&mut self) -> Result<&mut Self> {
        spin_appconfig::host_component::add_to_linker(&mut self.linker, |ctx| {
